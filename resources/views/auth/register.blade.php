                    ...
                    <div class="mt-32 mb-24 w-full rounded-lg shadow sm:max-w-md xl:p-0 bg-neutral-950">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form method="POST" action="{{ route('register') }}" class="space-y-4 md:space-y-6"
                                ...
                                <div class="flex flex-row gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="name" id="name"
                                            class="{{ $errors->has('name') ? 'bg-red-100 border-red-400 text-red-500 placeholder-red-700' : 'bg-white border-yellow-400 text-gray-900 placeholder-gray-400  focus:ring-yellow-400 focus:border-yellow-400' }} rounded-lg border-1 text-sm mt-3 block w-full p-2.5"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="phone_number" id="phone_number"
                                            class="{{ $errors->has('phone_number') ? 'bg-red-100 border-red-400 text-red-500 placeholder-red-700' : 'bg-white border-yellow-400 text-gray-900 placeholder-gray-400  focus:ring-yellow-400 focus:border-yellow-400' }} rounded-lg border-1 text-sm mt-3 block w-full p-2.5"
                                ...
                                <div class="flex flex-row gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="password_confirmation" id="confirm-password"
                                            placeholder="••••••••"
                                            class="{{ $errors->has('address') ? 'bg-red-100 border-red-400 text-red-500 placeholder-red-700' : 'bg-white border-yellow-400 text-gray-900 placeholder-gray-400 focus:ring-yellow-400 focus:border-yellow-400' }} rounded-lg border-1 text-sm mt-3 block w-full p-2.5"
                                            required>
                                ...
                                <button type="submit"
                                    class="w-full text-white bg-yellow-500 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                    Register
                                </button>

                                <p class="text-center text-sm font-light text-gray-400">
                                    Already got an account? <a href="{{ route('login') }}"
                                        class="font-medium text-yellow-400 hover:underline">Login</a>
                                </p>
                            </form>
                        </div>
                    </div>
