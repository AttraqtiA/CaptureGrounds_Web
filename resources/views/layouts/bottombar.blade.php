    ...
    <div class="mx-auto">
        <div class="text-white flex flex-col md:flex-row justify-center gap-6 px-4 md:px-0">
            ...
            <div class="w-full md:w-1/2">
                ...
                <p>Discover affordable photography and videography services for any occasion. Find your perfect match effortlessly!</p>
            </div>
            <div>
                ...
                <div class="flex flex-col md:flex-row gap-6 lg:gap-4">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <a class="flex flex-row items-center gap-4"
                            href="https://api.whatsapp.com/send?phone=6282136047069" target="_blank">
                        ...
                        <a class="flex flex-row items-center gap-4 mt-2 md:mt-0"
                            href="https://www.instagram.com/capturegrounds" target="_blank">
                            ...
                            <p class="hover:underline">capturegrounds</p>
                        </a>
