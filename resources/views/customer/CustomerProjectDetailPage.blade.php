...
@section('content_page')
    <div class="pt-10 md:pt-20 lg:pt-20 p-5 md:p-10 lg:p-20 mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:gap-x-8">
            <img class="rounded-lg w-full md:w-1/2" src="/images/serviceExample.png"
                alt="serviceexample" />
            <div class="flex flex-col md:w-1/2">
                <h3 class="mb-4 text-xl md:text-3xl lg:text-4xl font-bold text-gray-900">Professional Event Photography</h3>
                <p class="mb-2 text-sm md:text-md lg:text-lg font-medium text-gray-700">Capture your event beautifully with professional photography services. High-quality images delivered promptly.</p>
